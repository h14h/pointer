...
- **Undo across a keeper rewind** shows the automatic rewind toast immediately, then the manual "Pick undone" toast shortly afterward so the cursor movement reads before the restored manual pick
